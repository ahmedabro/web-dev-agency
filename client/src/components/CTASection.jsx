  ...
  return (
    <div className='h-full md:h-[450px] xl:h-[600px] relative w-full flex flex-col md:flex-row items-center'>
      <div className='md:w-[55%] w-full h-full'>
        <img loading='lazy' src={"https://res.cloudinary.com/dvmmkvu4o/image/upload/f_auto,q_auto/v1762855129/hire2_gwowat.jpg"} alt='Hire Us' className='w-full md:h-full hidden md:block md:max-h-[450px] xl:max-h-[600px] object-cover object-top shadow-lg opacity-40 brightness-90' />
      </div>
