...
const ContactForm = () => {
    ...
    return (
        <Formik
            initialValues={{ name: '', email: '', company: '', budget: '', message: '', interestedIn: '', country: '' }}
                ...
                return (
                    <Form className='flex flex-wrap justify-between gap-5 py-10 px-10'>
                        ...
                        <div className='w-full flex flex-col'>
                            ...
                            {errors.country && touched.country ? (<div className='text-red-500 text-sm mt-1'>{errors.country}</div>) : null}
                        </div>
