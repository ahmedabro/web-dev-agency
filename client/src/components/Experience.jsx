...
const Experience = () => {
  const { data, isLoading, isError, error, refetch } = useGetExperiencesQuery();
    ...
    <div className="experience-outer-wrapper w-full">
      ...
      >
        <div className="flex flex-col justify-center">
          ...
          <>
            <div className="section-container lg:mb-20!">
              <span className="section-subheading">Experience</span>
              <h2 className="section-mainheading mb-4">Where I've Worked</h2>
